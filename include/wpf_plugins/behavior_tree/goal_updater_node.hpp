...
#ifndef WPF_PLUGINS__BEHAVIOR__DECORATOR__GOAL_UPDATER_NODE_HPP_
#define WPF_PLUGINS__BEHAVIOR__DECORATOR__GOAL_UPDATER_NODE_HPP_
...
#include "nav_msgs/msg/path.hpp" // use the path message instead of the kilted goals message (they are the same)
...
public:
  ...
  static BT::PortsList providedPorts()
  {
    ...
    return {
      ...
      BT::InputPort<std::vector<geometry_msgs::msg::PoseStamped>>("input_goals", "Original Goals"),
...
private:
   ...
   */
  void callback_updated_goals(const nav_msgs::msg::Path::SharedPtr msg);

  rclcpp::Subscription<geometry_msgs::msg::PoseStamped>::SharedPtr goal_sub_;
  rclcpp::Subscription<nav_msgs::msg::Path>::SharedPtr goals_sub_;

  geometry_msgs::msg::PoseStamped last_goal_received_;
  bool last_goal_received_set_{false};
  nav_msgs::msg::Path last_goals_received_path_;
...
#endif  // WPF_PLUGINS__BEHAVIOR__DECORATOR__GOAL_UPDATER_NODE_HPP_
